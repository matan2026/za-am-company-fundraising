...
const supportAreas: Array<{ icon: NeedIconName; title: string; text: string }> = [
  ...
  },
  {
    ...
    text: "קיום ערבי מחלקה ופלוגה שמאפשרים לנו לעצור רגע, לעבד את התקופה המורכבת ולחזק את החיבור בין הלוחמים.",
  },
  {
    icon: "homeFront",
    title: "תמיכה בעורף הפלוגתי",
    text: "תמיכה במשפחות ובילדי הפלוגה ועזרה ללוחמים המתמודדים עם מצוקת קריירה עקב המילואים.",
  },
];
      ...
      <section className="thank-you-section thank-you-story" aria-labelledby="thank-you-story-title">
        <SectionContainer className="thank-you-reading">
          ...
          <div className="thank-you-prose">
            ...
            <p>
              התרומה שלכם מסייעת לחזק את הציוד האישי, את החוסן והלכידות הפלוגתית ואת התמיכה בעורף הפלוגתי, במשפחות ובילדי הפלוגה.
            </p>
            <p>
