...
export const donationAmounts = [
  ...
  },
  {
    amount: 750,
    label: "750 ₪",
    title: "שליש סט ציוד טקטי (חולצה/מכנס)",
    description:
      "השתתפות משמעותית ברכישת ציוד הלחימה ללוחם, המאפשרת לקנות חולצת לחימה נושמת או מכנסיים טקטיים עמידים.",
  },
  {
    amount: 1500,
    label: "1,500 ₪",
    ...
    description:
      "אתם רוכשים במלואו סט מדים טקטיים קומפלט (חולצה ומכנסיים) ללוחם שריון אחד, המותאם לשבועות ארוכים של לחימה בתוך הטנק ומחוצה לו.",
  },
  {
    amount: 6000,
    label: "6,000 ₪",
    ...
    description:
      "מציידים צוות טנק מלא (מפקד, תותחן, טען ונהג) בסטים טקטיים קומפלט ללחימה הבאה.",
  },
  {
    amount: 15000,
    label: "15,000 ₪",
    ...
    description:
      "רכישת מדים טקטיים ל-10 לוחמים, או מימון מלא של ערב חוסן פלוגתי משמעותי לעיבוד חוויות הלחימה.",
  },
  {
    amount: null,
    label: "סכום אחר",
